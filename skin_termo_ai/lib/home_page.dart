            ...
            children: [
              Expanded(
                child: _buildGlassActionCard(
                  ...
                  onTap: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(builder: (_) => const HealthcareChatPage()),
                    );
                  },
                ),
              ),
              ...
              Expanded(
                child: _buildGlassActionCard(
                  ...
                  onTap: () {
                    if (_featuredDoctor != null) {
                      Navigator.push(
                        context,
                        MaterialPageRoute(builder: (_) => DoctorProfilePage(doctor: _featuredDoctor!)),
                      );
                    } else {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('Finding available doctors...')),
                      );
                    }
                  },
                ),
